...
using bwd_v3_fp4_public_colwg_L4_SG8 = nvfp4_cce_backward_v3::experimental_config_colwg_colpair_rowpair_rowrecord_rowsync_dualfloatcache_row16ready_overlap<4, 8, true, 2>;
...
using bwd_v3_fp4_public_colwg_colpair_rowpair_rowrecord_rowsync_dualfloatcache_row16ready_overlap_EPI2_L4_SG8 = nvfp4_cce_backward_v3::experimental_config_colwg_colpair_rowpair_rowrecord_rowsync_dualfloatcache_row16ready_overlap<4, 8, true, 2>;
...
static void launch_backward_v3_fp4_public_dispatch_L4_SG8(
    ...
    bool encode_centric = false)
{
    // A fatter epilogue slice consistently wins on the shipped 32K and 128K
    // shapes by reducing per-slice overlap/synchronization overhead.
    launch_experimental_backward_v3_fp4_3wg<
        bwd_v3_fp4_public_colwg_L4_SG8>(
        A, A_sc, A_sc_global,
        B, B_sc, B_sc_global,
        G_fp4_row, G_sc_row, G_sg_row,
        G_fp4_col, G_sc_col,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("experimental_backward_v3_fp4_colwg_colpair_rowpair_rowrecord_rowsync_dualfloatcache_row16ready_overlap_epi2_L4_SG8", &launch_experimental_backward_v3_fp4_3wg<bwd_v3_fp4_public_colwg_colpair_rowpair_rowrecord_rowsync_dualfloatcache_row16ready_overlap_EPI2_L4_SG8>,
          "NVFP4 CCE backward v3 experimental public col-WG colpair+rowpair rowrecord dual float-cache row16-ready overlap EPI2 (FP4 output) L4 SG8");
    m.def("experimental_backward_v3_fp4_colwg_colpair_rowpair_rowrecord_rowsync_dualfloatcache_row16ready_overlap_epi2_L4_SG8", &launch_experimental_backward_v3_fp4_3wg<bwd_v3_fp4_public_colwg_colpair_rowpair_rowrecord_rowsync_dualfloatcache_row16ready_overlap_EPI2_L4_SG8>,
          "NVFP4 CCE backward v3 experimental public col-WG colpair+rowpair rowrecord dual float-cache row16-ready overlap EPI2 (FP4 output) L4 SG8");
