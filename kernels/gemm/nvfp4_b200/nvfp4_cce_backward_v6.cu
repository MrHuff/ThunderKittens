...
static void launch_experimental_backward_v6_combo_publicv3_fp4(
    const at::Tensor &A, const at::Tensor &A_sc, const at::Tensor &A_sc_global,
    const at::Tensor &B, const at::Tensor &B_sc, const at::Tensor &B_sc_global,
    ...
    bool encode_centric = false)
{
    ...
    TORCH_CHECK(filter_eps == 0.0f,
                "experimental_backward_v6_combo_publicv3_fp4_L4_SG8 does not support filter_eps yet.");
...
template <typename C, int ComboMode>
static void launch_experimental_backward_v6_combo_publicv3_fp4_5wg(
    const at::Tensor &A, const at::Tensor &A_sc, const at::Tensor &A_sc_global,
    const at::Tensor &B, const at::Tensor &B_sc, const at::Tensor &B_sc_global,
    const at::Tensor &C_col, const at::Tensor &C_col_sc, const at::Tensor &C_col_sc_global,
    const at::Tensor &E_col, const at::Tensor &E_col_sc, const at::Tensor &E_col_sc_global,
    ...
    bool encode_centric = false)
{
    using FrontendC = exp_bwd_v6_combo_publicv3_fp4_L4_SG8;
    constexpr int FrontendGonlyMode =
        nvfp4_cce_backward_v3::globals_3wg<FrontendC>::COMBO_MODE_GONLY;

    launch_experimental_backward_v6_combo_publicv3_fp4<
        FrontendC, FrontendGonlyMode>(
        A, A_sc, A_sc_global,
        B, B_sc, B_sc_global,
    ...
    if constexpr (ComboMode == nvfp4_cce_backward_v3::globals_5wg<C>::COMBO_MODE_GONLY) {
        return;
    }

    if constexpr (ComboMode == nvfp4_cce_backward_v3::globals_5wg<C>::COMBO_MODE_FULL ||
                  ComboMode == nvfp4_cce_backward_v3::globals_5wg<C>::COMBO_MODE_DEONLY) {
    ...
    if constexpr (ComboMode == nvfp4_cce_backward_v3::globals_5wg<C>::COMBO_MODE_FULL ||
                  ComboMode == nvfp4_cce_backward_v3::globals_5wg<C>::COMBO_MODE_DCONLY) {
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("experimental_backward_v6_combo_publicv3_fp4_L4_SG8",
          &launch_experimental_backward_v6_combo_publicv3_fp4<
              exp_bwd_v6_combo_publicv3_fp4_L4_SG8,
              nvfp4_cce_backward_v3::globals_3wg<exp_bwd_v6_combo_publicv3_fp4_L4_SG8>::COMBO_MODE_FULL>,
          "Developer-only NVFP4 v6 combo path using the public-v3 front-half and in-kernel store-add dE/dC");
    ...
    m.def("experimental_backward_v6_combo_publicv3_fp4_dEonly_L4_SG8",
          ...
          "Developer-only NVFP4 v6 combo path using the public-v3 front-half plus in-kernel dE only");
    m.def("experimental_backward_v6_combo_publicv3_fp4_dConly_L4_SG8",
          ...
          "Developer-only NVFP4 v6 combo path using the public-v3 front-half plus in-kernel dC only");
    m.def("experimental_backward_v6_combo_publicv3_fp4_5wg_L4_SG8",
          &launch_experimental_backward_v6_combo_publicv3_fp4_5wg<
              exp_bwd_v6_combo_publicv3_fp4_5wg_L4_SG8,
              nvfp4_cce_backward_v3::globals_5wg<exp_bwd_v6_combo_publicv3_fp4_5wg_L4_SG8>::COMBO_MODE_FULL>,
          "Developer-only NVFP4 v6 combo path using the public-v3 front-half plus dedicated 5wg back-half consumers");
    ...
    m.def("experimental_backward_v6_combo_publicv3_fp4_5wg_dEonly_L4_SG8",
          ...
          "Developer-only NVFP4 v6 5wg combo path using the public-v3 front-half plus dedicated dE");
    m.def("experimental_backward_v6_combo_publicv3_fp4_5wg_dConly_L4_SG8",
          ...
          "Developer-only NVFP4 v6 5wg combo path using the public-v3 front-half plus dedicated dC");
}
#endif
